...
namespace Web.Command
{
    public class ByteFormat
    {
        ...
        static readonly ConcurrentDictionary<string, TypeInfo> InstanceCache = new ConcurrentDictionary<string, TypeInfo>();
        static readonly Type stringType = typeof(string);
        static readonly string[] ListTypeStrs = { "List`1", "HashSet`1", "IList`1", "ISet`1", "ICollection`1", "IEnumerable`1" };
        static readonly string[] DicTypeStrs = { "Dictionary`2", "IDictionary`2" };
        ...
        /// <returns></returns>
        private static object[] Deserialize(Type[] types, byte[] datas)
        {
        ...
        private static object Deserialize(Type type, byte[] datas, ref int offset)
        {
            ...
            if (len > 0)
            {
                ...
                else if (type == typeof(DateTime))
                {
                    ...
                    var ticks = long.Parse(Substring(dstr, 2));
